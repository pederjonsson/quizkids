...
public class DatabaseUtil {
    ...
    public List<QuestionAnswers> generateQABuildings(Context context){
        ...
        qaList.add(generateQA(R.string.q_buildings_sphinx, Question.Category.BUILDINGS, R.drawable.question_eiffel200, Question.DifficultyLevel.EASY,context.getString(R.string.q_buildings_sphinx_correct_answer), context.getString(R.string.q_buildings_sphinx_answer2), context.getString(R.string.q_buildings_sphinx_answer3)));
